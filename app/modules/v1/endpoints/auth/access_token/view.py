...
class AccessTokenView(AsyncResource):
    ...
    def __init__(self):
        ...
        self.parser.add_argument('username', type=str, required=True, help="Username is mandatory")
        self.parser.add_argument('password', type=str, required=True, help="Password is mandatory")
    ...
    async def post(self) -> ApiResponse:
        ...
        token_params: TokenResponse | None = await login_user_service.get_token(request=token_request, secret_key=secret_key)
        if token_params:
