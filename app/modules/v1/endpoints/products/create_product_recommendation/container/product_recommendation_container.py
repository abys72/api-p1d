...
from dependency_injector.providers import Singleton, Factory, Dependency
...
class ProductRecommendationContainer(DeclarativeContainer):
    ...
    insert_product_recommendation_query = Singleton(InsertProductRecommendationQuery, session=mongo_session,
                                                    logger=insert_query_logger)
    get_product_recommendation_query = Singleton(GetProductRecommendationQuery, session=mongo_session,
                                                 logger=get_query_logger)
    product_recommendation_repository = Factory(ProductRecommendationRepository,
    ...
    product_recommendation_service = Factory(ProductRecommendationService,
